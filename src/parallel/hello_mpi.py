...
print(f"rank {my_rank} got random data from right neighbor {recv_buf} (must not be zeros)")



# sending python objects
#comm.send([1,2,3], dest=left, tag=2)
#comm.recv(data_right, source=right, tag=2)
